...
namespace Roz.Infrastructure.Web.Validation.Attributes
{
    public class EmailAddressAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        {
            var vstring = (string)value;
            return string.IsNullOrEmpty(vstring) || EmailRegex.IsMatch(vstring);
        }
        ...
        public virtual IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            yield return new ModelClientValidationRule
            {
                ...
                ErrorMessage = string.IsNullOrWhiteSpace(ErrorMessage) ? LocalizedExtensions.GetText(ErrorMessageResourceName) : ErrorMessage
            };
        }
    }
}