...
{
    public class DbContextScope : IDataContextScope
    {
        ...
        private DbContextCollection _dataContexts;

        public IDataContextCollection DataContexts { get { return _dataContexts; } }

        public DbContextScope(IDataContextFactory dbContextFactory = null) :
        ...
        public DbContextScope(bool readOnly, IDataContextFactory dbContextFactory = null)
        ...
        public void RefreshEntitiesInParentScope(IEnumerable entities)
        {
			...
			foreach (IObjectContextAdapter contextInCurrentScope in _dataContexts.InitializedDbContexts.Values)
            {
                var correspondingParentContext =
                    _parentScope._dataContexts.InitializedDbContexts.Values.SingleOrDefault(parentContext => parentContext.GetType() == contextInCurrentScope.GetType())
